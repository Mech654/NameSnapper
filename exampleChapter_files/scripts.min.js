...
function getUrlParameter(a) {
    var e, t, n = decodeURIComponent(window.location.search.substring(1)).split("&");
    for (t = 0; t < n.length; t++) { if ((e = n[t].split("="))[0] === a) return (void 0 === e[1] ? "" : e[1]).replace(/\+/g, " ").trim() }
}
...
function chapterJump(a, e, t) {
    $(".chr-nav").on("click", "button.chr-jump", (function() {
        ...
        if (sub_site == 'true') {
            ajaxChapterOptionUrlAPI = ajaxChapterOptionUrlAPI + `?subsite=1`;
        }
...
function chapterDetail(a, e) {
    ...
    if (sub_site == 'true') {
        ...
        if (currentUrl.searchParams.has('subsite')) {
            currentUrl.search = 'subsite=1';
        } else {
            currentUrl.search = "";
        }
...
$((function() {
    ...
    function n(a) {
        var ajaxSearchNovelUrlAPI = ajaxSearchNovelUrl;
        const sub_site = $('meta[name="sub_site"]').attr('content');
        if (sub_site == 'true') {
            ajaxSearchNovelUrlAPI = ajaxSearchNovelUrlAPI + `?subsite=1`;
        }
        $.get(ajaxSearchNovelUrlAPI, { keyword: a }).done((function(a) { $(".list-search-res").html(a) }))
    }
